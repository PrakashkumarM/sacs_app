...
import 'package:sacs_app/app/common/widgets/dropdown_clone/src/keyboard_suggestion_selection_notifier.dart';
import 'package:sacs_app/app/common/widgets/dropdown_clone/src/should_refresh_suggestion_focus_index_notifier.dart';
...
class DropDownSearchField<T> extends StatefulWidget {
  ...
  final void Function(bool, bool)? onSuggestionsBoxToggle;
  ...
  void initState() {
    ...
    this._focusNodeListener = () {
      if (_effectiveFocusNode!.hasFocus) {
        ...
        widget.onSuggestionsBoxToggle
            ?.call(this._suggestionsBox!.isOpened, false);
      ...
      // print('_areSuggestionsFocused:${_areSuggestionsFocused}');
    };
      ...
      final suggestionsList = SuggestionsList<T>(
        ...
        onSuggestionSelected: (T selection) {
          if (!widget.keepSuggestionsOnSuggestionSelected) {
            ...
            this._suggestionsBox!.close();
            widget.onSuggestionsBoxToggle
                ?.call(this._suggestionsBox!.isOpened, true);
          }
        ...
        child: TextFieldTapRegion(
            ...
            child: _suggestionsBox!.direction == AxisDirection.down
                ...
                : FractionalTranslation(
                    transformHitTests:
                        true, // Ensures hit-tests (tap and scroll) are transformed
