...
import 'package:sacs_app/app/core/utils/extensions.dart';
...
class CustomColors {
  ...
  static Color darkLinearColorStart = HexColor.fromHex('#3C4557');
  static Color darkLinearColorEnd = HexColor.fromHex('#384152');
